...
class APIRoutes:
    ...
    async def generate(self, req_data: GenerateRequest) -> GenerateResponse:
        ...
        try:
            ...
            if req_data.stream:
                ...
                finished_req = await self.request_queue.wait_for_request(
                ...
                return GenerateResponse(
                    ...
                    tokens_per_sec=(
                        len(finished_req.generated_ids) * 1000 / latency_ms
                        if latency_ms > 0
                        else 0
                    ),
                )
    ...
    async def _stream_tokens(
        self, request_id: str, chunk_size: int
    ...
    async def metrics(self) -> MetricsResponse:
        ...
        return MetricsResponse(
            ...
            avg_throughput_tokens_per_sec=engine_metrics.get(
