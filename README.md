...
```bash
# Clone repository
git clone https://github.com/your-username/custom-llm-inference-server.git
...
@software{custom_llm_inference_2024,
  ...
  author={Contributors},
  year={2024},
  url={https://github.com/your-username/custom-llm-inference-server}
}
```
...
- **Issues:** [GitHub Issues](https://github.com/your-username/custom-llm-inference-server/issues)
- **Discussions:** [GitHub Discussions](https://github.com/your-username/custom-llm-inference-server/discussions)
