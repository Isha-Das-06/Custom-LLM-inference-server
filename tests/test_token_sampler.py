...
def test_token_sampler_greedy():
    ...
    logits = torch.tensor([[1.0, 5.0, 2.0, 1.0]], dtype=torch.float32)
...
def test_token_sampler_top_k():
    ...
    logits = torch.tensor([[10.0, 9.0, 1.0, 1.0, 1.0]], dtype=torch.float32)
...
def test_token_sampler_top_p():
    ...
    logits = torch.tensor([[100.0, 10.0, 1.0, 1.0]], dtype=torch.float32)
